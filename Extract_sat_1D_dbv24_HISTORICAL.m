...
% prods={'chlor_a','Rrs_667','ABI','Kd_490'}; % MODA OC

% This script extracts for all years and takes a few hours to run
% Run this at least once per year, as the "recent" function goes back 365 days
...
cd(path_out)
eval(['save ' roi_2 'dbv24_' prods{p} '_TS_' sensor '_1D_raw_vHISTORICAL.mat ts_tmp'])
cd(path_main)
clear ts_tmp
end % Prod Loop (p)
