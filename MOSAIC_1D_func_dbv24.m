...
% % TEST
% clear
% pc='SSTN'; % Use SSTN for VIIRS nighttime SST
% roi='seus';
% roi_2='SEUS';
% sensor='VSNPP';
% sub=1; % Indicates to be used with recent files from subscription directories
% rec_files=15; % Number of most recent files to process; Set to zero for all recent files 
